...
export const HamburgerMenuProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <HamburgerMenuContext.Provider value={{ getIsOpen, toggleMenu, openMenu, closeMenu }}>
      {children}
...
export const useHamburgerMenu = (key: string) => {
  ...
  if (!context) throw new Error("useHamburgerMenu must be used within HamburgerMenuProvider");
